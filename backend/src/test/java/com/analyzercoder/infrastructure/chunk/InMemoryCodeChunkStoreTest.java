...
class InMemoryCodeChunkStoreTest {
    ...
    void paginatesRepositoryChunksInFilePathOrder() {
        ...
        List<CodeChunk> page = store.findByRepositoryId(repositoryId, 2, 1);
    ...
    void searchesChunksCaseInsensitivelyAndRanksFilePathMatchesFirst() {
        ...
        List<CodeChunk> results = store.searchByRepositoryId(repositoryId, "ORDER", 10, 0);
    ...
    private CodeChunk chunk(CodeRepositoryId repositoryId, String filePath, String language, String content) {
        return CodeChunk.fileChunk(repositoryId, "test-commit", filePath, language, 1, 1, content);
    }
}
