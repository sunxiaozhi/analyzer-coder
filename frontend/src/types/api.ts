...
export interface CodeChunk{id:string;repositoryId:string;contentVersion:string;commitSha:string;filePath:string;symbolId:string|null;symbolName:string|null;symbolKind:string|null;language:string|null;assetType:RepositoryAssetType;chunkType:ChunkType;startLine:number|null;endLine:number|null;content:string;contentHash:string;createdAt:string}
...
export interface RepositoryContentVersionFiles{contentVersion:string;branch:string|null;commit:string|null;files:RepositoryFileEntry[]}
export interface RepositoryFileContent{contentVersion:string;path:string;name:string;language:string;sizeBytes:number;lineCount:number;content:string}
