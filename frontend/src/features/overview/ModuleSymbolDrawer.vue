...
.drawer-heading span { color: #08795f; font: 700 9px Consolas, monospace; letter-spacing: .14em; }
.drawer-heading strong { color: #263b48; font: 650 16px Consolas, monospace; }
.drawer-heading small { color: #7b8991; font-size: 9px; }
.symbol-tools { display: grid; gap: 7px; padding-bottom: 12px; border-bottom: 1px solid #e3e9ed; }
.symbol-tools > span { color: #7d8992; font-size: 9px; }
...
.symbol-kind { padding: 2px 5px; color: #315f7c; border-radius: 3px; background: #eaf2f6; font: 700 8px Consolas, monospace; }
.symbol-source strong { overflow: hidden; color: #2d414e; font: 600 11px Consolas, monospace; text-overflow: ellipsis; white-space: nowrap; }
.symbol-source small { grid-column: 1 / -1; display: flex; align-items: center; gap: 4px; overflow: hidden; color: #7d8a92; font: 500 8px Consolas, monospace; text-overflow: ellipsis; white-space: nowrap; }
.graph-action { display: flex; align-items: center; justify-content: center; gap: 3px; color: #08795f; border: 0; border-left: 1px solid #e0e7e9; background: #f2f8f6; font-size: 9px; }
