...
:deep(.drawer-empty .empty-mark) { display: grid; place-items: center; width: 42px; height: 42px; margin-bottom: 12px; color: #2b6cb0; border: 1px solid #bad0e2; border-radius: 50%; background: #f3f8fc; font: 20px "SFMono-Regular", Consolas, monospace; }
:deep(.drawer-empty strong) { color: #34434d; font-size: 13px; }
:deep(.drawer-empty p) { max-width: 230px; margin: 7px 0 0; font-size: 11px; line-height: 1.55; }
...
:deep(.drawer-content > header small) { color: #77858e; font: 700 9px "SFMono-Regular", Consolas, monospace; letter-spacing: .08em; text-transform: uppercase; }
...
:deep(.drawer-content button:hover) { border-color: #8fb5d5; color: #2b6cb0; }
:deep(.drawer-content button:focus-visible) { outline: 3px solid #2b6cb02d; outline-offset: 2px; }
:deep(.status-line) { justify-self: start; padding: 4px 7px; color: #2b6cb0; border-left: 3px solid currentColor; background: #eef5fa; font-size: 10px; font-weight: 700; }
:deep(.status-line.kind-knowledge) { color: #1f7a5a; background: #edf7f2; }
...
:deep(.status-line.kind-model) { color: #70559b; background: #f1ecf7; }
:deep(.description) { margin: -4px 0 0; color: #596973; font-size: 12px; line-height: 1.6; }
...
:deep(dt), :deep(dd) { margin: 0; padding: 8px 9px; border-bottom: 1px solid #edf0f2; font-size: 10px; }
...
:deep(.evidence-list h3) { margin: 0 0 1px; color: #52616b; font-size: 11px; }
:deep(.evidence-list article) { display: grid; gap: 4px; padding: 9px; border-left: 2px solid #9cbdd6; background: #f7fafc; }
:deep(.evidence-list small) { color: #6f7e88; font: 9px "SFMono-Regular", Consolas, monospace; }
:deep(.evidence-list strong) { color: #2b3942; font-size: 11px; }
:deep(.evidence-list p) { margin: 0; color: #697780; font-size: 10px; line-height: 1.45; }
:deep(.evidence-list code) { overflow-wrap: anywhere; color: #526b7c; font: 9px "SFMono-Regular", Consolas, monospace; }
:deep(.drawer-content > footer) { display: flex; flex-wrap: wrap; gap: 7px; padding-top: 2px; }
:deep(.drawer-content > footer button) { display: inline-flex; align-items: center; gap: 6px; min-height: 33px; padding: 0 10px; color: #34546a; border: 1px solid #cfdde6; border-radius: 6px; background: #f7fafc; font-size: 11px; font-weight: 650; }
