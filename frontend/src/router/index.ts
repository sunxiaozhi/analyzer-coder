...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/', component: WorkspaceShell, children: [
      ...
      { path: 'indexing', name: 'indexing', component: IndexJobsView, meta: { title: '任务中心' } },
      { path: 'search', name: 'search', component: ChunksView, meta: { title: '联合检索' } },
      { path: 'atlas', name: 'atlas', component: () => import('@/views/CodeAtlasView.vue'), meta: { title: '代码图谱' } },
      { path: 'ask', name: 'ask', component: AskView, meta: { title: '项目问答' } },
      {
        path: 'graph',
        name: 'graph',
        redirect: to => ({
      ...
      { path: 'knowledge', name: 'knowledge', component: KnowledgeView, meta: { title: '知识管理', repositoryRead: true } },
