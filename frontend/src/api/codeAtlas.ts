...
export function getCodeAtlas(repositoryId: string, module = '', query = '') {
  return request<AtlasView>(`/api/repositories/${repositoryId}/codegraph/explore?${new URLSearchParams({ module, query })}`);
}
