...
const workflowCards = computed<GuideCard[]>(() => {
  ...
  const review = evidenceAccess('可以审查');
  ...
  return [
    ...
    },
    {
      ...
      number: '03',
      title: '代码与证据',
      description: '浏览源码、检索代码片段，并沿符号关系核对原始文件与行号。',
      source: '当前快照文件、code_chunks 与 CodeGraph',
      status: code.status,
    ...
    },
    {
      ...
      number: '04',
      title: '问项目',
      description: '用自然语言提问，并从引用回到当前仓库的代码或知识证据。',
      source: '当前快照检索、已发布知识与问答模型',
      status: ask.status,
    ...
    },
    {
      ...
      number: '05',
      title: '变更审查',
      description: '在改动前估算影响，在改动后核对真实 Git 差异、规则和测试。',
      source: 'Git Diff、当前快照、知识规则与图谱',
      status: review.status,
      statusTone: review.statusTone,
      action: review.action,
      target: review.target || '/change-impact',
      icon: GitCompare,
      accent: 'warning',
    },
    {
      ...
      number: '06',
      title: '知识治理',
      description: '查看规则、Markdown 预备知识和失效线索；维护能力由仓库权限决定。',
  ...
  <div class="feature-guide-page">
    ...
    <section class="guide-section" aria-labelledby="workflow-title">
      <div class="section-heading">
        <div>
          <span>推荐顺序</span>
          <h2 id="workflow-title">从仓库接入到知识沉淀</h2>
        </div>
